...
export default function Contact(): JSX.Element {
  const allLinks = [
    { title: "Email", icon: <FiMail />, url: "mailto:vardaansharma100@gmail.com" },
    { title: "Schedule Call", icon: <FiPhone />, url: "tel:+91%208595568004", external: true },
    { title: "GitHub", url: "https://github.com/VardaanSharma100", icon: <SiGithub /> },
    {
      title: "LinkedIn",
      icon: <SiLinkedin />,
      url: "https://www.linkedin.com/in/vardaansharma100",
      external: true,
    },
  ];
        ...
        <div className="px-2 md:px-4 h-full min-h-0 flex flex-col justify-start">
          <div className="w-full min-h-full z-30 relative">
            ...
            <p className="text-black dark:text-[var(--text)] mt-16 md:mt-8 mb-0 text-center text-lg w-full">
              ...
              <a
                href="mailto:vardaansharma100@gmail.com"
                className="underline underline-offset-2"
              >
                vardaansharma100@gmail.com
              </a>
            </p>
